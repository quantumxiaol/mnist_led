...
class NeuronVisualizer(QMainWindow):
    ...
    def init_model(self):
        ...
        self.model = SimpleNeuralNetworkG().to(self.device)
        self.model.load_state_dict(torch.load('./saved_weights/simple_nn_mnist.pth', map_location=self.device))
        self.model.eval()
        
    def init_ui(self):
        self.setWindowTitle('Simple Neural Network 神经元激活可视化')
        ...
        self.layer_widgets = {}
        self.layer_widgets['fc1'] = NeuronLayerWidget('FC1 隐藏层 (128)', 128, 128)
